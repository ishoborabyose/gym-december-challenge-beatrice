...
<div className="gap-[1.5rem] grid grid-rows-3 mt-[2.5rem] lg:grid-cols-3 ">
<div className="text-white bg-[#3070B3] lg:row-span-1 p-[20px] text-center ">
        <div className="text-[80px] font-bold">50,000</div>
        <p className="text-[20px] font-bold mt-[8px]">Student</p>
      </div>

<div className="lg:grid grid-cols gap-10 lg:grid-rows-2">
